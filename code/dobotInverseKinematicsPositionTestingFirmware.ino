...
Open Source BenchBot GUI firmware:
...
void setup() {
  ...
  //Connect to the serial port. Use baud rate 115200 for Arduino Mega 2560
  Serial.begin(115200);

/* these settings need to be optimized, especially when using lower microstepping settings. 
  These worked well with 1/16th, and decent with 1/8 (slipping occured if moving too fast though) */
